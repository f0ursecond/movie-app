...
import 'package:movie_app/core/favorite/favorite_screen.dart';
...
class AppRouter {
  static Route? onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      case RoutePath.navigationScreen:
        return RouteBuilder.navigationScreen();
      ...
      case RoutePath.favoriteScreen:
        return customTransitionRouteBuilder(FavoriteScreen());
      default:
        onErrorRoute();
    }
